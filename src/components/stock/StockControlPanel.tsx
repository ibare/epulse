...
export function StockControlPanel({ viewDef }: StockControlPanelProps) {
  ...
  const guideText = viewDef.id === 'stock-kr'
    ? '한국 주식시장에 영향을 주는 변수를 조절하며 거시 지표가 주가에 어떻게 반영되는지 살펴보세요.'
    : '미국 주식시장에 영향을 주는 변수를 조절하며 거시 지표가 주가에 어떻게 반영되는지 살펴보세요.';
